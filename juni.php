...
<body>
    ...
    <button id="scrollToTopBtn" class="scrollToTopBtn btn btn-black hide">
        <div class="icon up">
    ...
    <div class="container-l padding-bottom-5rem">
        <div class="padding-top-3rem padding-bottom-1rem padding-bottom-5rem-m" id="el3">
            ...
            <div class="button-row center">
                ...
                <a class="btn btn-black mail" href="mailto:hoi@ruitenberg.nl?body=Hoi Thomas!" target="_blank"

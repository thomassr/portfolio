...
<head>
    ...
    <script src="/scripts/scrollBtn.js" defer></script>  
...
<body>
    ...
    <div class="hero purple overflow-hidden">
        <div class="container-xl text-center center padding-top-3rem padding-top-5rem-m style">
    ...
    <div class="sticky-btns" id="sticky-btns">
        <a id="navigate-contact-sticky" class="btn btn-black hand">say hoi</a>
        <a id="to-top-btn" class="btn btn-black icon-only">
            <div class="icon">
    ...
    <div class="container-l padding-bottom-5rem">
        <div class="padding-top-3rem padding-bottom-1rem padding-bottom-5rem-m" id="el3">
            ...
            <div class="button-row center">
                ...
                <div class="fade-Y-bottom-l">
                    <a class="btn btn-black show-mobile" href="mailto:hoi@ruitenberg.nl?body=Hoi Thomas!" id="copy-email" target="_blank"
                        rel="noopener noreferrer">say hoi with an email</a>
                    <button type="button" class="btn btn-black copy-mail show-large" data-copy="hoi@thomasruitenberg.nl" style="width: 280px;">say hoi with an email</button>                     
                    </div>
                <div class="fade-Y-bottom-l" style="transition-delay: 50ms;">
                <a class="btn btn-black"
                    href="https://www.linkedin.com/in/thomasruitenberg/" target="_blank"
                    rel="noopener noreferrer">or connect on LinkedIn</a>
                </div>
                <a class="fade-Y-bottom-l btn btn-black" style="transition-delay: 100ms;"
                href="/index.html#el1" rel="noopener noreferrer">check out more work</a>
                </div>
